...
@NamedQuery(name = "VisitServicesModel.findVisitServicesByVisitId", query = "select vsm from VisitServicesModel vsm where vsm.visitid=:visitid and billId is not null")
